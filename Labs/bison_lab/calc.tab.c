...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_9_ = 9,                         /* ')'  */
  YYSYMBOL_10_ = 10,                       /* '^'  */
  YYSYMBOL_square_root = 11,               /* square_root  */
  YYSYMBOL_pi = 12,                        /* pi  */
  YYSYMBOL_squared = 13,                   /* squared  */
  YYSYMBOL_14_ = 14,                       /* '#'  */
  YYSYMBOL_15_I_ = 15,                     /* 'I'  */
  YYSYMBOL_16_ = 16,                       /* '%'  */
  YYSYMBOL_17_ = 17,                       /* '{'  */
...
{
       0,     3,    11,    12,     2,     2,     2,     2,     2,     2,
      19,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,    14,     2,    16,     2,     2,
       8,     9,     6,     5,     2,     4,     2,     7,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
static const char *const yytname[] =
{
  ...
  "'*'", "'/'", "'('", "')'", "'^'", "square_root", "pi", "squared", "'#'",
  "'I'", "'%'", "'{'", "'}'", "'\\n'", "$accept", "input", "line", "exp",
  "exp_list", "sum", YY_NULLPTR
};
...
{
     -17,    24,   -17,   -17,    72,    72,    -7,   -17,    72,    72,
     -17,   -17,    40,   -17,   112,    86,    72,   112,    57,   -16,
      72,    72,    72,    72,    72,   -17,    72,   -17,   -17,    99,
      72,   -17,   -17,   112,   112,   112,   112,   112,   112,   -17,
     112
};
...
{
       2,     0,     1,     6,     0,     0,     0,    15,     0,     0,
       4,     3,     0,    19,    11,     0,     0,    17,    20,     0,
       0,     0,     0,     0,     0,    16,     0,     5,    12,     0,
       0,    21,    22,     8,     7,     9,    10,    13,    18,    14,
       8
};
...
{
      12,    16,    32,    14,    15,    31,     0,    17,     0,     0,
       0,     0,     0,     0,     0,    29,     0,     0,     0,    33,
      34,    35,    36,    37,     2,    38,     0,     3,     4,    40,
       0,     0,     5,     0,     0,     6,     7,     0,     0,     8,
       0,     9,     0,    10,    20,    21,    22,    23,     0,     0,
      24,     0,     0,    25,     0,     0,    26,     0,     0,    27,
       3,    30,    21,    22,    23,     5,     0,    24,     6,     7,
      25,     0,     8,    26,     9,     3,     4,     0,     0,     0,
       5,     0,     0,     6,     7,     0,     0,     8,     0,     9,
      20,    21,    22,    23,     0,    28,    24,     0,     0,    25,
       0,     0,    26,    20,    21,    22,    23,     0,    39,    24,
       0,     0,    25,     0,     0,    26,    20,    21,    22,    23,
       0,     0,    24,     0,     0,    25,     0,     0,    26
};

static const yytype_int8 yycheck[] =
{
       1,     8,    18,     4,     5,    18,    -1,     8,    -1,    -1,
      -1,    -1,    -1,    -1,    -1,    16,    -1,    -1,    -1,    20,
      21,    22,    23,    24,     0,    26,    -1,     3,     4,    30,
      -1,    -1,     8,    -1,    -1,    11,    12,    -1,    -1,    15,
      -1,    17,    -1,    19,     4,     5,     6,     7,    -1,    -1,
      10,    -1,    -1,    13,    -1,    -1,    16,    -1,    -1,    19,
       3,     4,     5,     6,     7,     8,    -1,    10,    11,    12,
      13,    -1,    15,    16,    17,     3,     4,    -1,    -1,    -1,
       8,    -1,    -1,    11,    12,    -1,    -1,    15,    -1,    17,
       4,     5,     6,     7,    -1,     9,    10,    -1,    -1,    13,
      -1,    -1,    16,     4,     5,     6,     7,    -1,     9,    10,
      -1,    -1,    13,    -1,    -1,    16,     4,     5,     6,     7,
...
{
       0,    21,     0,     3,     4,     8,    11,    12,    15,    17,
      19,    22,    23,    25,    23,    23,     8,    23,    23,    24,
       4,     5,     6,     7,    10,    13,    16,    19,     9,    23,
       4,    24,    18,    23,    23,    23,    23,    23,    23,     9,
      23
};
